    ...
    #Función filas tabla resultado:
        def filastabla(self):
                for fila in self.resultados:
                        ...
                        self.pdf.cell(w=36, h= 8,border= 1,align= "C",txt= fila[0], 
                                fill = 0)
                        self.pdf.cell(w=36, h= 8,border= 1,align= "C",txt= fila[1],
                                fill = 0)
                        self.pdf.cell(w=27, h= 8,border= 1,align= "C",txt= fila[2],
                                fill = 0)
                        self.pdf.cell(w=45, h= 8,border= 1, align= "C",txt= fila[3],
                                fill = 0)
                        self.pdf.cell(w=36, h= 8,border= 1, align= "C",txt= fila[4],
                                fill = 0)
