...
class EquiposForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'tipoCalibracion': forms.Select(attrs={'class': 'form-control form-control-sm secado', 'style': 'text-align: center;', 'type': 'date'}),
            'estadoCalibracion': forms.Select(attrs={'class': 'form-control form-control-sm secado', 'style': 'text-align: center;', 'type': 'date'}),
