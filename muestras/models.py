...
class DescripcionMuestra(models.Model):
    ...
    empresaTransporte= models.CharField(max_length= 300, verbose_name="Empresa transportes", null=True, blank=True)
    documentacion= models.CharField(max_length= 300, choices=documentacion, verbose_name="Documentación", null=True, blank=True)
    ...
    humedadAparente= models.CharField(max_length= 300, verbose_name="Humedad aparente", null=True, blank=True)
