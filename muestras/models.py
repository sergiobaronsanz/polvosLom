...
class DescripcionMuestra(models.Model):
    ...
    empresaTransporte= models.CharField(max_length= 300, verbose_name="Empresa transportes", default="-")
    ...
    humedadAparente= models.CharField(max_length= 300, verbose_name="Humedad aparente", default= "-")
